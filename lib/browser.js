...
function Socket(options) {
  ...
  if (protocol === 'ws:' && CLIENT_OPTIONS.srvPort) {
    port = ":" + CLIENT_OPTIONS.srvPort;
  } else if (protocol === 'wss:' && CLIENT_OPTIONS.srvSecurePort) {
  ...
  function createBrowserChannel () {
    ...
    self.open = createBrowserChannel;
